...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [FANSPEED] = ColorPair(Yellow, White),
   ...
   [COLORSCHEME_LIGHTTERMINAL] = {
      ...
      [FANSPEED] = ColorPair(Yellow, Black),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [FANSPEED] = A_BOLD | ColorPair(Yellow, Blue),
   ...
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [TEMPERATURE_MEDIUM] = A_NORMAL | ColorPair(Yellow,Black),
      [TEMPERATURE_HOT] = A_BOLD | ColorPair(Red,Black),
      [FANSPEED] = A_BOLD | ColorPair(Green, Black),
